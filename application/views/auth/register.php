            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <form class="mt-4" action="<?= base_url('register/proses') ?>" method="POST">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="nmlengkap">Nama Lengkap</label>
                                        <input class="form-control" id="nmlengkap" type="text" name="nama_lengkap"
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                     ready account? <a href="<?= base_url('login') ?>" class="text-danger">Sign In</a>
                                </div>
                            </div>
                        </form>
                    </div>
