...
<script>
    $(document).ready(function () {
        ...
        $('#laporan_data_peminjaman_asset').DataTable({
            "pageLength": 25,
            "dom": 'lBTfgtp',
            "buttons": [{
                extend: 'copy'
        ...
        $('#body-data-peminjaman-asset').on('click', '.btn-update', function () {
        ...
        $('#btn-export').click(function (e) { 
            ...
            var page = "export-data-peminjaman-asset?id_asset=" + id_asset + "&dari=" + dari + '&sampai=' + sampai; 
