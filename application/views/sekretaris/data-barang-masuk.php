                                            ...
                                            <?php
                                                ...
                                                foreach ($databarangmasuk as $db) {
                                                    echo '<tr>
                                                            ...
                                                            data-id_supplier="'.$db->id_supplier.'"
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('barang-masuk/insert') ?>" method="POST" id="form-tambah">
                                <div class="form-group">
                                    ...
                                    <select class="form-control mr-sm-2" id="inlineFormCustomSelect" name="id_barang" required>
                                    <?php
                                    $var = $this->db->get('data_barang')->result();

                                    foreach ($var as $v){
                                    echo '<option value="'.$v->id.'">'.$v->nama_barang.'</option>';
                                    }
                                    ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control mr-sm-2" id="inlineFormCustomSelect" name="id_supplier" required>
                                    <?php
