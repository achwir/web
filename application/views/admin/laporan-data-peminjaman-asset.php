<div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Laporan Data Peminjaman Asset</h3>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="<?= base_url('admin/laporan-data-peminjaman-asset') ?>" method="POST" id="form-tambah">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                    <table id="laporan_data_peminjaman_asset" class="table table-striped table-bordered no-wrap">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama Asset</th>
                                        ...
                                        <tbody id="body-data-peminjaman-asset">
                                            <?php
                                                $no = 1;
