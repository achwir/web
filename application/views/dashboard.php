                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="barang-masuk mt-4 position-relative" style="height:294px;"></div>
                                <ul class="list-inline text-center mt-5 mb-2">
                                    <li class="list-inline-item text-muted font-italic">Data Barang Masuk</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <h4 class="card-title mb-0">Barang Masuk Pertahun</h4>
                                    <div class="ml-auto">
                                    </div>
                                </div>
                                <div class="pl-4 mb-5">
                                    <div class="stats-year ct-charts position-relative" style="height: 315px;"></div>
                                </div>
                                <ul class="list-inline text-center mt-4 mb-0">
                                    <li class="list-inline-item text-muted font-italic">Data Barang Masuk Pertahun</li>
                                </ul>
                            </div>
                        </div>
                    </div>
